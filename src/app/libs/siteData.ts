...
export const slides = [
  ...
  { id: 'slide2', imageUrl: '/logos/Mitsubishi.svg' },
  { id: 'slide3', imageUrl: '/logos/Mitsubishi.svg' },
  { id: 'slide4', imageUrl: '/logos/Mitsubishi.svg' },
];

// popular car Info
export const popCars =[
  {
    id: 1,
...
// comapny loactions
export const locations = ["Dubai", "Abu Dhabi", "Sharjah", "Fujairah", "Ras Al Khaimah"]

// rent lease steps data
export const rentLeaseData = [
    {
      id: 1,
